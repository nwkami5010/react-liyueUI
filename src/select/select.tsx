...
export const RootSelect: FC<SelectProps> = props => {
  ...
  const containerClass = classNames('l-select', {
  ...
  return (
    <div className={containerClass} ref={containerRef}>
      <div className="l-select-input" onClick={handleClick}>
        <Input
          ref={inputRef}
      ...
      <SelectContext.Provider value={passedContext}>
        <Transition in={menuOpen} animation="zoom-in-top" timeout={300}>
          <ul className="l-select-dropdown">{generateOptions()}</ul>
        </Transition>
      </SelectContext.Provider>
      {multiple && (
        <div
          className="l-selected-tags"
